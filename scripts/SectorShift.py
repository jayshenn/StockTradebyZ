...
from core.selector import compute_kdj
from scripts.select_stock import load_data
...
def compute_j_industry_distribution(
    *,
    ...
    stocklist_path: Union[str, Path] = "configs/stocklist.csv",
...
def main() -> None:
    ...
    parser.add_argument("--stocklist", type=str, default="configs/stocklist.csv", help="stocklist.csv 路径")
